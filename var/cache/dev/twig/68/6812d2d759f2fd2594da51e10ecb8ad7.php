...
class __TwigTemplate_717c833e9c7d6698059ed7ed79f72d9a extends Template
{
    private $source;
    private $macros = [];
...
{% endfor %}
{% endif %}
", "@Twig/Exception/traces.txt.twig", "/Applications/MAMP/htdocs/FIND-v2/test/vendor/symfony/twig-bundle/Resources/views/Exception/traces.txt.twig");
    }
}
